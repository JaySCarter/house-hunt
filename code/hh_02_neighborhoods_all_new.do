...
local butterbiggins_streets "grenoch bally_shannon havelock_ct ness"
...
local neighborhoods "n_butterbiggins "
...
//Cane Creek
gen foggy_morning = regexm(res_street_address, "FOGGY MORNING")
gen dragon_fly = regexm(res_street_address, "DRAGON FLY")
gen moon_water = regexm(res_street_address, "MOON WATER")
gen water_lilly = regexm(res_street_address, "WATER LILLY")
gen sailboat = regexm(res_street_address, "SAILBOAT ")
gen n_cane_creek = cane_creek
foreach st of local n_cane_creek_streets {
